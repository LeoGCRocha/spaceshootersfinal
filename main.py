...
player = Player((width/2)-(99/2),(height-75)-30)
...
def gameShop():
	...
	text3 = myFont.render("Vida Extra (50 Moedas):", True, (255, 255, 255))
	imgLoad = ""
	posX, posY = 0,120
	# Atual
	if player.getImgSrc() == "res/_player/player_1.png":
		...
		imgLoad = pygame.image.load("res/_ui/blue_sliderDown.png")
		posX = 540
	elif player.getImgSrc() == "res/_player/player_4.png":
		imgLoad = pygame.image.load("res/_ui/red_sliderDown.png")
		posX = 655
	elif player.getImgSrc() == "res/_player/player_5.png":
		imgLoad = pygame.image.load("res/_ui/red_sliderDown.png")
		posX = 775
	...
	player_red = pygame.image.load("res/_player/player_4.png")
	player_antigo = pygame.image.load("res/_player/player_5.png")
	...
	while gameShop:
		...
		gameDisplay.blit(text3,(10,70))
		# Comprar Skins
		gameDisplay.blit(greyPanel,(50,120))
		gameDisplay.blit(greyPanel,(170,120))
		gameDisplay.blit(greyPanel,(290,120))
		gameDisplay.blit(greyPanel, (410, 120))
		gameDisplay.blit(greyPanel, (530, 120))
		gameDisplay.blit(greyPanel, (650,120))
		gameDisplay.blit(greyPanel, (770,120))
		gameDisplay.blit(player_orange,(58,140))
		gameDisplay.blit(player_green,(178,140))
		gameDisplay.blit(player_blue,(298,140))
		gameDisplay.blit(ovni, (425, 150))
		gameDisplay.blit(player_white, (540, 130))
		gameDisplay.blit(player_red,(658,128))
		gameDisplay.blit(player_antigo,(778,130))
		gameDisplay.blit(imgLoad,(posX,posY))
		# Painel para Comprar vida
		if player.getLife() <= 3:
			gameDisplay.blit(greyPanel,(50,260))
			gameDisplay.blit(life,(63,275))
		# Exit icon
		...
		for event in pygame.event.get():
			...
			if event.type == pygame.MOUSEBUTTONUP:
				...
				if x >= 915 and x <= 965 and y >= 610 and y <= 675:
					...
					gameMenu()
					break
				if x >= 50 and x <= 167 and y >= 135 and y <= 243:
					posX = 50
					comprarItem(20,"res/_player/player_2.png")
				elif x >= 170 and x <= 286 and y >= 135 and y <= 243:
					posX = 170
					comprarItem(20,"res/_player/player_3.png")
				elif x >= 290 and x <= 395 and y >= 135 and y <= 243:
					posX = 290
					comprarItem(20,"res/_player/player_1.png")
				elif x >= 410 and x <= 527 and y >= 135 and y <= 243:
					posX = 410
					comprarItem(20,"res/_player/Ovni.png")
				elif x >= 530 and x <= 600 and y >= 135 and y <= 243:
					posX = 530
					comprarItem(20,"res/_player/Nave_branca.png")
				elif x >= 630 and x <= 750 and y >= 135 and y <= 243:
					posX = 658
					comprarItem(20,"res/_player/player_4.png")
				elif x >= 770 and x <= 850 and y >= 135 and y <= 243:
					posX = 770
					comprarItem(20,"res/_player/player_5.png")

				elif x >= 50 and x <= 167 and y >= 260 and y <= 378 and player.getLife() <= 3:
...
def gameInstrucoes():
	...
	while not gameOn:
		...
		text3 = myFont3.render("Seta pra direita => Direita", True, (255, 255, 255))
		text4 = myFont3.render("Seta pra esquerda => Esquerda", True, (255, 255, 255))
