...
def gameShop():
	...
	while gameShop:
		...
		gameDisplay.blit(greyPanel, (650,80))
		gameDisplay.blit(greyPanel, (770,80))
		...
		gameDisplay.blit(player_red,(658,88))
		gameDisplay.blit(player_antigo,(778,90))
		...
		for event in pygame.event.get():
			...
			if event.type == pygame.MOUSEBUTTONUP:
				...
				elif x >= 630 and x <= 750 and y >= 95 and y <= 203:
					posX = 658
					comprarItem(20,"res/_player/player_4.png")
				elif x >= 770 and x <= 850 and y >= 95 and y <= 203:
					posX = 770
					comprarItem(200,"res/_player/player_5.png")
